...
export default function LoveMessageCard({
  message = "The flowers for the special one , the flower which will be with u every moment.I know they are not the real ones 😔but here are some flowers for the my pretty flowerr",
  reminder = "You are doing veryyy greatt and the most imp thing is that you are giving your 200% but haa sometimes thing don't go as the way we plann and thats completely OKAYYY .Your competition is with you and not with others so dont compare urself with others ever, just focus on the thinggss.What matters most is the effort and time you invest.",
  onClose
}) {
